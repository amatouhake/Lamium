...
Json encode(Settings const& settings) {
    ...
    return Json{
        ...
        {"camera", {{"zoom", settings.camera.zoom}, {"freelook", settings.camera.freelook}, {"freelookToggle", settings.camera.freelookToggle}, {"magnification", settings.camera.magnification},
