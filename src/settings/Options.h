...
inline constexpr auto options = std::to_array<Option>({
    ...
    choice<&Settings::interaction, &Settings::Interaction::attackTrigger, interaction::fastTriggerLabels>("interaction.attackTrigger", "periodicAttack", "fastTriggerRow"),
    ...
    choice<&Settings::interaction, &Settings::Interaction::useTrigger, interaction::fastTriggerLabels>("interaction.useTrigger", "periodicUse", "fastTriggerRow"),
