...
| [hotkey-conflicts.html](hotkey-conflicts.html) | Open questions | Warning style for shared/overlapping bindings in every key cell and a hover tooltip listing every related binding (L-32 follow-up). |
