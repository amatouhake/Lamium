...
1. **Fix observed day-to-day behavior:** L-16 (in-game check), L-15 (Design).
...
Status: decided and implemented 2026-09-25 (DESIGN "Light overlay",
docs/demos/light-overlay.html); awaiting in-game check.
